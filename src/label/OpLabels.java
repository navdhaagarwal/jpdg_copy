...
public class OpLabels implements LabelMaker {
    ...
    public void postLabel(pDG_Build pDG, int uid, Block b) {
    ...
    public String label(pDG_Build pDG, Block b) {
    ...
    public String label(pDG_Build pDG, soot.Unit u) {
    ...
    public String label(pDG_Build pDG, soot.Value left, soot.Value right) {
    ...
    public String label(pDG_Build pDG, soot.Value value) {
    ...
    public void add_constants(pDG_Build pDG, int uid, soot.Unit u) {
    ...
    public void add_constant(pDG_Build pDG, int container_uid, soot.Unit container, soot.jimple.Constant c) {
