...
public class pDG_Build {
    ...
    public static void build(CallGraph cg, Map<String,Integer> method_entries, LabelMaker lm, Graph g, soot.SootClass c, soot.SootMethod m, soot.Body body, BlockGraph cfg) throws Error {
        pDG_Build self = new pDG_Build(cg, method_entries, lm, g, c, m, body, cfg);
        self.build_pDG();
    }

    static pDG_Build test_instance() {
        return new pDG_Build();
    }

    private pDG_Build() {}

    private pDG_Build(CallGraph cg, Map<String,Integer> method_entries, LabelMaker lm, Graph g, soot.SootClass c, soot.SootMethod m, soot.Body body, BlockGraph cfg) throws Error {
        this.cg = cg;
